angular.module('app')
    .controller('questionsCtrl', function ($state, $rootScope, $scope, masterService) {})
    .controller('questionsListCtrl', function($state, $rootScope, $scope, $stateParams, $uibModal, questionsService, userService){
    ...
    .controller('questionsView',function($scope, $rootScope, $state, $stateParams, decode, $uibModal, questionsService,$location){
        $rootScope.displayName = $stateParams.mName+" - "+ $stateParams.name;
        $rootScope.breadcrumbcolor='';
        $rootScope.class='';
        $rootScope.icon='';
        $scope.topic_id = decode($stateParams.id);
        $rootScope.module = "Questions";
        $scope.question = {};
        $scope.req = {};
        $scope.req.status=0;
        ...
        $scope.getQuestionsList = function(){
            questionsService.getTopicQuestions({'id_topic':$scope.topic_id}).then (function(result){
                if(result.status){
        ...
        $scope.loadModal = function(type,row){
            ...
            var modalInstance = $uibModal.open({
                ...
                templateUrl: 'views/questions/questions-modal.html',
                resolve : {
                    item : row
                },
                controller: function ($uibModalInstance, $scope , item) {
                    ...
                    $scope.addQuestion =  function (question){
                        ...
                        obj1.action_description = $scope.action+'$$question$$'+question.question_text;
